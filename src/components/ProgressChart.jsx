...
//   if (error) {
//     return <div className="text-red-500 font-semibold ml-64 mt-4">{error}</div>;
//   }

//   if (data.length === 0) {
//     return <div className="ml-64 mt-4">Loading progress chart...</div>;
//   }
...
//   return (
//     <div className="w-full px-4 md:ml-64 mt-8 flex flex-col items-center">
//         <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center">
//             Interview Skill Progress Over Time
//         </h2>

//         <div className="w-full overflow-x-auto">
//             <div className="min-w-[800px] max-w-5xl h-[400px] bg-white rounded-lg shadow-md p-4">
