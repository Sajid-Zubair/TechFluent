...
//       setAnswer(data.analysis || 'No feedback received.');
//     } catch (err) {
...
//           <FaRegLightbulb className="text-green-500" /> Overall Impression
//         </h3>
//         <div className="prose prose-sm max-w-none">
//           <ReactMarkdown>{answer.analysis.overall_impression}</ReactMarkdown>
//         </div>
//       </motion.div>
...
//           <FaRegFileAlt className="text-blue-500" /> Content & Skills
//         </h3>
//         <div className="prose prose-sm max-w-none">
//           <ReactMarkdown>{answer.analysis.content_skills}</ReactMarkdown>
//         </div>
//       </motion.div>
...
//           <FaTools className="text-purple-500" /> Clarity & Impact
//         </h3>
//         <div className="prose prose-sm max-w-none">
//           <ReactMarkdown>{answer.analysis.clarity_impact}</ReactMarkdown>
//         </div>
//       </motion.div>
...
//       >
//         <h3 className="text-lg font-semibold flex items-center gap-2 text-pink-700">
//           <FaRegFileAlt className="text-pink-500" /> Formatting & Readability
//         </h3>
//         <div className="prose prose-sm max-w-none">
//           <ReactMarkdown>{answer.analysis.formatting_readability}</ReactMarkdown>
//         </div>
//       </motion.div>
...
//           <FaRegFileAlt className="text-orange-500" /> ATS Compatibility
//         </h3>
//         <div className="prose prose-sm max-w-none">
//           <ReactMarkdown>{answer.analysis.ats_compatibility}</ReactMarkdown>
//         </div>
//       </motion.div>
...
//         </h3>
//         <p className="text-xl font-bold">{answer.analysis.final_score}</p>
//       </motion.div>
